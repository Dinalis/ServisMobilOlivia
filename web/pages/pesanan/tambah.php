  <div class="col-xs-12 col-sm-12 col-md-10">
		  <ol class="breadcrumb">
			  ...
			  <li><a href="index.php?pages=pesanan"><span class="fa fa-modx"></span> Pesanan</a></li>
			  <li class="active"><span class="fa fa-clone"></span> Tambah Data</li>
			</ol>
			 
		  	<p style="margin-bottom:10px;">
		  		<strong style="font-size:18pt;"><span class="fa fa-clone"></span> Tambah Pesanan</strong>
		  	</p>
		  	<div class="panel panel-default">

			<div class="panel-body">
			
			    <form method="post" action="index.php?pages=pesanan&modul=simpan&act=baru">
				  ...
				  <div class="form-group">
				   ...
				   <select name='select1' id="select1" class="form-control" onchange="showDiv(this)">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" id='datepicker' class="form-control" name="tanggal_pesanan" required>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <textarea id="editor1" name="catatan" class="form-control"></textarea>
				  </div>
