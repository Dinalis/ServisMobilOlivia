...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2018 at 10:46 AM
...
(1, 'admin           ', '21232f297a57a5a743894a0e4a801fc3', 'admin', 'Admin1       ', '081332098096           ', ' gandhi@yahoo.com       ', 1, '2018-06-09 15:46:20', 'administrator'),
...
CREATE TABLE `tbl_pesanan` (
  ...
  `no_plat_bk` varchar(25) NOT NULL,
  `tipe_mobil` varchar(35) NOT NULL,
...
INSERT INTO `tbl_pesanan` (`id`, `nama`, `no_telp`, `no_plat_bk`, `tipe_mobil`, `jenis_pesanan`, `pesanan_tambahan`, `total_biaya`, `tanggal_pesanan`, `waktu_pesanan`, `catatan`) VALUES
(6, 'Yudith', '08372813389', 'BK 1 D', 'Ertiga', 'Paket Exclusive', 'spoorbal', 550000, '2018-06-09', 'Pukul 08:00 WIB-selesai', 'ok');
